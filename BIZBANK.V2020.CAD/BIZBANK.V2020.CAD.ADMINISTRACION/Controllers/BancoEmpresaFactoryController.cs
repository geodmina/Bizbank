    ...
    public class BancoEmpresaFactoryController : ControllerBase
    {
        ...
        )
        {
            ...
            try
            {
                ...
                dbms.AddParameter("i_cod_empresa", DBType.dbInteger, ParamDirection.ParamInput, 0, codEmpresa);
                ...
                if (!dbms.Execute(idTransaccion, permiso, parServicio, "pr_crg_ad_banco_por_empresa", "BZA_PQ_BIZ_EMPRESA", ExecuteType.ResultSet, ExecuteMode.LocalMode, 0))
                {
        ...
        )
        {
            ...
            try
            {
                ...
                // LLAMADA DE LA EJECUCIÓN DE LA TRANSACCIÓN
                if (!dbms.Execute(idTransaccion, permiso, parServicio, "pr_crg_ad_banco_por_empresaRol", "BZA_PQ_BIZ_EMPRESA", ExecuteType.ResultSet, ExecuteMode.LocalMode, 0))
                {
