...
namespace BIZBANK.V2020.CIU.ADMINISTRACION.Controllers
{
    ...
    public class EmpProServFactoryController : ControllerBase
    {
        ...
        const string c_rutaAPI = "/api/EmpProServFactory/";
        ...
        private readonly string c_claseNombre = "EmpProServFactoryController";

        public EmpProServFactoryController(IConfiguration configuracion)
        {
        ...
        )
        {
            ...
            const string c_metodoNombre = "CargaServiciosEmpresaProducto";
            using (var cliente = new HttpClient())
            {
                try
                {
