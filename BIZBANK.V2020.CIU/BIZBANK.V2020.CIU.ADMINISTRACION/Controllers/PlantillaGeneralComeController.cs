...
namespace BIZBANK.V2020.CIU.ADMINISTRACION.Controllers
{
    ...
    public class PlantillaGeneralComeController : ControllerBase
    {
        ...
        const string c_rutaAPI = "/api/PlantillaGeneralCome/";
        ...
        public PlantillaGeneralComeController(IConfiguration configuracion)
        {
        ...
        )
        {
            ...
            const string c_metodoNombre = "GetTransaccionesPorEmpresa";
            using (var cliente = new HttpClient())
            {
                try
                {
                    ...
                    url = string.Format("{0}{1}?codBanco={2}&codEmpresa={3}&codProducto={4}" +
                        "&codModulo={5}&codServicio={6}&idTransaccion={7}&permiso={8}" +
                        "&parServicio={9}",
