...
namespace BIZBANK.V2020.CIU.ADMINISTRACION.Controllers
{
    ...
    public class UsuarioBancoFactoryController : ControllerBase
    {
        ...
        const string c_rutaAPI = "/api/UsuarioBancoFactory/";
        ...
        private readonly string c_claseNombre = "UsuarioBancoFactoryController";

        public UsuarioBancoFactoryController(IConfiguration configuracion)
        {
        ...
        )
        {
            ...
            const string c_metodoNombre = "CargarBancoUsuario";
            using (var cliente = new HttpClient())
            {
                try
                {
                    ...
                    segmentoCodigo = "BLOQUE 20";
                    string url = string.Empty;
                    url = string.Format("{0}{1}?codUsuario={2}&idTransaccion={3}&permiso={4}&parServicio={5}",
                        c_rutaAPI, c_metodoNombre, codUsuario, idTransaccion, permiso, parServicio);
