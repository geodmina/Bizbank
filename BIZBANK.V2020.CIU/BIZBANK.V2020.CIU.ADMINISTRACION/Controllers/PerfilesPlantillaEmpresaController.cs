...
namespace BIZBANK.V2020.CIU.ADMINISTRACION.Controllers
{
    ...
    public class PerfilesPlantillaEmpresaController : ControllerBase
    {
        ...
        const string c_rutaAPI = "/api/PerfilesPlantillaEmpresa/";
        ...
        private readonly string c_claseNombre = "PerfilesPlantillaEmpresa";

        public PerfilesPlantillaEmpresaController(IConfiguration configuracion)
        {
        ...
        )
        {
            ...
            const string c_metodoNombre = "GetModuloRol";
        ...
        )
        {
            ...
            const string c_metodoNombre = "GetTranPlantillas";
            using (var cliente = new HttpClient())
            {
                try
                {
                    ...
                    string url = string.Empty;
                    url = string.Format("{0}{1}?codBanco={2}&codEmpresa={3}&codProducto={4}" +
                        "&codModulo={5}&codServicio={6}&codRol={7}&idTransaccion={8}&permiso={9}" +
                        "&parServicio={10}",
                        c_rutaAPI, c_metodoNombre, codBanco, codEmpresa, codProducto, codModulo,
                        codServicio, codRol, idTransaccion, permiso, parServicio);
