...
namespace BIZBANK.V2020.CIU.ADMINISTRACION.Controllers
{
    ...
    public class ModuloController : ControllerBase
    {
        ...
        private readonly string c_claseNombre = "ModuloController";

        public ModuloController(IConfiguration configuracion)
        {
        ...
        )
        {
            ...
            const string c_metodoNombre = "ModuloPorProducto";
        ...
        )
        {
            ...
            const string c_metodoNombre = "ModuloPrdServ";
            using (var cliente = new HttpClient())
            {
                try
                {
