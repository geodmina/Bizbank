...
namespace BIZBANK.V2020.CIU.ADMINISTRACION.Controllers
{
    ...
    [ApiController]
    public class EmpresaProServController : ControllerBase
    {

        private readonly IConfiguration configuracion;
        const string c_rutaAPI = "/api/EmpresaProServ/";
        ...
        private readonly string c_claseNombre = "EmpresaProServController";

        public EmpresaProServController(IConfiguration configuracion)
        {
