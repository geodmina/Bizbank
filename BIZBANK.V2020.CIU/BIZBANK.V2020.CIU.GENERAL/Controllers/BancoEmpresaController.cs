...
namespace BIZBANK.V2020.CIU.GENERAL.Controllers
{
    ...
    public class BancoEmpresaController : ControllerBase
    {
        ...
        const string c_rutaAPI = "/api/BancoEmpresa/";
        ...
        private readonly string c_claseNombre = "BancoEmpresaController";

        public BancoEmpresaController(IConfiguration configuracion)
        {
       ...
       )
        {
            ...
            const string c_metodoNombre = "GetCodEmpresaPorBanco";
            using (var cliente = new HttpClient())
            {
                try
                {
                    ...
                    url = string.Format("{0}{1}?codigoBanco={2}&idTransaccion={3}&permiso={4}" +
                        "&parServicio={5}",
                        c_rutaAPI, c_metodoNombre, codigoBanco, idTransaccion, permiso, parServicio);
